    ...
    <div class="container">
	    <div class="row">
	        <div class="container-form">
	            <?php
		        $sentencia = $conexion->prepare("SELECT * FROM empresa WHERE id = ?;");
				...
				<form action="actualizarEmpresa.php" method="POST">
	                ...
	                <input class="form-control mb-4" value="<?php echo $resultado->empresa ?>" name="empresa" required type="text" id="empresa" placeholder="Digite el nombre de su empresa...">

	                <label class="form-label" for="correo">Correo Electronico</label><br>
	                <input class="form-control mb-4" value="<?php echo $resultado->correo ?>" name="correo" required type="text" id="correo" placeholder="Digite el correo electronico...">
