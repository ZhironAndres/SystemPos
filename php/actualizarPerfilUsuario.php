...
$sql = "UPDATE formulariousu SET foto = ?, descripcion = ?, ciudad = ?, departamento = ?, fechaNaci = ?, residencia = ?, sexo = ?, documento = ?, numDocumet = ?, nombreEmpresa = ?, fechaInicio = ?, fechaFinal = ?, cargo = ?, nomInstitu = ?, fechaInicial = ?, fechaFinalizacion = ?, certificados = ?, files = ?, lenguajes = ?, herramientas = ? WHERE usuario_id = ?";

$stmt = $conexion->prepare($sql);

$stmt->execute([$nombreFoto, $descripcion, $ciudad, $departamento, $fechaNaci, $residencia, $sexo, $documento, $numDocumet, $nombreEmpresa, $fechaInicio, $fechaFinal, $cargo, $nomInstitu, $fechainicial, $fechaFinalizacion, $certificados, $nombreCV, $lenguajes, $herramientas, $id]);
